...
# load model
ds = Model('model/deepspeech/output_graph.pbmm', N_FEATURES, N_CONTEXT, 'model/deepspeech/alphabet.txt', BEAM_WIDTH)
ds.enableDecoderWithLM('model/deepspeech/alphabet.txt', 'model/deepspeech/lm.binary', 'model/deepspeech/trie',
